...
from wopi_validator import version


PROJECT = 'wopi_validator'
...
setup(
        ...
        entry_points={
            'console_scripts': [
                'wopi-validator=wopi_validator.validator:cli',
            ],
        },
        url='',
        license='MIT',
        ...
        tests_require=get_install_requirements('requirements.txt'),
        extras_require={
        },
